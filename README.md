...
└── Part2_GPU_CrashCourse/    # 下半年：GPU 加速
    ...
    ├── 07_Multi_Node_GPU_Example/  # MPI+CUDA 探測 + PJM 多 vnode 範例
...
5. 進階多節點：[`07_Multi_Node_GPU_Example/`](Part2_GPU_CrashCourse/07_Multi_Node_GPU_Example/)（`mpi_cuda_rank_info`、`job_mpi_cuda_rank_info.sh`）；進階腳本可見 **`$HOME/sample/GPU_multiNodes/`**
